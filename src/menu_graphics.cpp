        ...
        video{video}, ui{ui}
{
    ...
    /*nk_style_set_font(ui->context, &roboto->handle);*/}
...
void GraphicsMenu<rs4::VideoSDLGL>::render(float alpha)
{
    ...
    if (subscreen != nullptr)
    {
        ...
        ui->beginRendering();
        if (nk_begin(ui->context, "Űrdemo", nk_rect(50, 50, 230, 250),
            ...
            NK_WINDOW_MINIMIZABLE|NK_WINDOW_TITLE))
        {
            ...
            if (nk_option_label(ui->context, "easy", op == EASY)) op = EASY;
            if (nk_option_label(ui->context, "hard", op == HARD)) op = HARD;
            ...
            if (nk_combo_begin_color(ui->context, nk_rgb_cf(ui->bg), nk_vec2(nk_widget_width(ui->context),400))) {
                nk_layout_row_dynamic(ui->context, 120, 1);
                ui->bg = nk_color_picker(ui->context, ui->bg, NK_RGBA);
                nk_layout_row_dynamic(ui->context, 25, 1);
                ui->bg.r = nk_propertyf(ui->context, "#R:", 0, ui->bg.r, 1.0f, 0.01f,0.005f);
                ui->bg.g = nk_propertyf(ui->context, "#G:", 0, ui->bg.g, 1.0f, 0.01f,0.005f);
                ui->bg.b = nk_propertyf(ui->context, "#B:", 0, ui->bg.b, 1.0f, 0.01f,0.005f);
                ui->bg.a = nk_propertyf(ui->context, "#A:", 0, ui->bg.a, 1.0f, 0.01f,0.005f);
